...
- Include the informational lines verbatim: the `#NNNN NAME` header, the `====` rule, and every `Label   value` line (Generation, Rarity, Caught, Shiny, catch history, totals, and any "Not yet caught"/progress messages).
